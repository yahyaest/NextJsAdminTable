...
function AdminFormDefault(props) {
  ...
  var attributsList = [];
  if (Object.keys(currentTable).length === 0 && typeof window !== "undefined") router.push("/admin/");
          ...
          switch (_context.prev = _context.next) {
            ...
            case 9:
              ...
              if (elementAdded && !(elementAdded !== null && elementAdded !== void 0 && elementAdded.isError)) {
                ...
                window.location.replace("/admin"); // await sleepTime(5000);
            ...
            case 13:
              ...
              if (!(Object.keys(currentComponent).length === 0 && uploadType !== "FormData")) {
                _context.next = 20;
                break;
              }
