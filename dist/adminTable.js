...
function AdminTable(props) {
  ...
  , {
    ...
    }), (currentTable === null || currentTable === void 0 ? void 0 : currentTable.elementUpdate) && /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement("button", {
      onClick: function onClick() {
        var _currentTable$data;

        return router.push("/admin/".concat(currentTable === null || currentTable === void 0 ? void 0 : (_currentTable$data = currentTable.data) === null || _currentTable$data === void 0 ? void 0 : _currentTable$data.name, "/").concat(element.id || element._id, "/"));
      },
